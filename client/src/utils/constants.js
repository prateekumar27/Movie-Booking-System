...
export const theatres = [
  {
    name: "PVR Centrio, Unison Mall, Dehradun",
    distance: "2.7 km",
    cancellation: "Allows cancellation",
    img: inox,
    timings: [
      { time: "10:15 AM", label: "RECLINERS" },
      { time: "1:30 PM", label: "RECLINERS" },
      { time: "5:00 PM", label: "RECLINERS", highlight: true },
      { time: "8:30 PM", label: "RECLINERS" },
      { time: "11:45 PM", label: "RECLINERS" },
    ],
  },
  {
    name: "PVR Pacific Mall, Rajpur Road, Dehradun",
    distance: "5.8 km",
    cancellation: "Allows cancellation",
    img: pvr,
    timings: [
      { time: "11:00 AM", label: "3D" },
      { time: "2:30 PM", label: "3D" },
      { time: "6:15 PM", label: "3D", highlight: true },
      { time: "9:45 PM", label: "3D" },
    ],
  },
  {
    name: "PVR Mall of Dehradun, Haridwar Road, Dehradun",
    distance: "6.8 km",
    cancellation: "Allows cancellation",
    img: inox,
    timings: [
      { time: "10:30 AM", label: "RECLINERS" },
      { time: "1:45 PM", label: "DOLBY 7.1" },
      { time: "5:15 PM", label: "DOLBY 7.1", highlight: true },
      { time: "8:50 PM", label: "RECLINERS" },
      { time: "11:55 PM", label: "DOLBY 7.1" },
    ],
  },
  {
    name: "Silvercity, Parsvnath Eleganza Mall, Rajpur Road, Dehradun",
    distance: "2.9 km",
    cancellation: "Allows cancellation",
    img: pvr, // import silvercity from "../assets/silvercity.png"
    timings: [
      { time: "12:00 PM", label: "RECLINERS" },
      { time: "3:30 PM", label: "RECLINERS" },
      { time: "7:00 PM", label: "RECLINERS", highlight: true },
      { time: "10:30 PM", label: "RECLINERS" },
    ],
  },
  {
    name: "New Empire Cinema, Chukkuwala, Dehradun",
    distance: "0.8 km",
    cancellation: "Non-cancellable",
    img: inox, // import newEmpire from "../assets/newEmpire.png"
    timings: [
      { time: "11:30 AM", label: "STANDARD" },
      { time: "3:00 PM", label: "STANDARD" },
      { time: "6:30 PM", label: "STANDARD", highlight: true },
      { time: "10:00 PM", label: "STANDARD" },
    ],
  },
];
