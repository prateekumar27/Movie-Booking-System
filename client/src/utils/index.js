...
export const groupSeatsByType = (seats) => {
  ...
  seats.forEach((seat) => {
    // handle both string "E1" or object { type, seatNumber, price }
    const seatId = typeof seat === "object" ? seat.seatNumber : seat;
    const type = typeof seat === "object" ? seat.type : getSeatType(seat);
